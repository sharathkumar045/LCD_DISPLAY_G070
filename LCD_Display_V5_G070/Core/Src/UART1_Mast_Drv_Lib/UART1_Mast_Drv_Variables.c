...
//xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
   ...
   // variables related to UART1_Rec_Transmission
      ...
      struct U1_Mast_Drv_Rec_Flags U1Mast_Drv_Rec_Flags;


      struct U1_Mast_Drv_Rec_Var U1Mast_Drv_Rec_Var;

      struct UART1_Master_Ctrl_Struct UART1_Master_Ctrl;
...
//UART1 variables related to message sending
       ...
       struct U1_Mast_Drv_Send_Flags U1Mast_Drv_Send_Flags;

       struct U1_Mast_Drv_Send_Var U1Mast_Drv_Send_Var;
