...
#define UART2_Enable_Receive_Interrupt  USART4->CR1|=USART_CR1_RXNEIE_RXFNEIE
#define UART2_Disable_Receive_Interrupt  USART4->CR1&=~LL_USART_CR1_RXNEIE_RXFNEIE
#define UART2_Enable  USART4->CR1|=USART_CR1_UE
#define UART2_Transmit_Not_Complete !(USART4->ISR&LL_USART_ISR_TC)
#define UART2_Clear_Receive_Flag USART4->RQR|=USART_RQR_RXFRQ
#define UART2_Rec_Data_Register USART4->RDR
#define UART2_Disable_Recv_INT USART4->CR1&=(~LL_USART_CR1_RXNEIE_RXFNEIE)
...
//UART2 variables related to message sending
 ...
 extern struct U2_Send_Var UART2_Send_Var;
      ...
      #define UART2_Transmit_Data_register USART4->TDR
      #define UART2_TRx_Complete (USART4->ISR&0x00000040)
 ...
 struct U2_Msg_Send_Reqt_Flags {
	    ...
	    __IO unsigned Msg_g: 1;  // message for gsm
